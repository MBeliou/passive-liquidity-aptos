...
export class TappAPI {
	...
	async getPoolPrices() {
		throw 'Unimplemented';
		/*
		query: {"method":"public/pool_price_chart","jsonrpc":"2.0","id":252841082,"params":{"query":{"poolId":"0x4ed8fda291b604491ead0cc9e5232bc1edc1f31d0e0cf343be043d8c792af1a8","startTime":1759233600000,"endTime":1759323599999,"interval":"1h"}}}
		interval: 1h / 4h / 1d
